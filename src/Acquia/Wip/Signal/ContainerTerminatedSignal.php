...
/**
 * Indicates a container has been terminated.
 */
class ContainerTerminatedSignal extends ProcessSignal implements ContainerTerminatedSignalInterface {
  ...
  public function __construct() {
    $this->setType(SignalType::TERMINATE);
  }
  ...
  public function initializeFromSignalData($signal_data) {
    ...
    if (isset($signal_data->log)) {
      $this->setLog(strval($signal_data->log));
    }
  }
