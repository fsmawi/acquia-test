...
module.exports = {
  ...
  'Tag-label': '//span[contains(text(),"Tag")]',
  'Branch-label': '//span[contains(text(),"Branch")]',
  ...
  'Tag-tooltip-text': 'The git tag used to run this job.',
  'Branch-tooltip-text': 'The git branch used to run this job.',
